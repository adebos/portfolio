jQuery(document).ready(function() {
	function c(c) {
		return c = JSON.stringify(c), c = c.replace(/\"n\":/g, '"name":').replace(/\"s\":/g, '"size":').replace(/\"c\":/g, '"color":').replace(/\"hc\":/g, '"hovercolor":').replace(/\"a\":/g, '"animate":').replace(/\"i\":/g, '"iteration":').replace(/\"d\":/g, '"duration":').replace(/\"l\":/g, '"loop":').replace(/\"et\":/g, '"eventtype":').replace(/\"op\":/g, '"onparent":'), c = JSON.parse(c)
	}

	function l(c) {
		if (null == c || "object" != typeof c) return c;
		var C, z = new c.constructor;
		for (C in c) z[C] = l(c[C]);
		return z
	}
	var C = (C = JSON.stringify({
			...
			balloons: {
				...
				sh: [{
					...
					i: {
						a: {
							p: "M12.852,18.112C12.798,18.74,12.993,19.496,14,20h-4c1.007-0.504,1.202-1.26,1.148-1.888C7.583,17.444,5,12.71,5,9c0-3.866,3.134-7,7-7s7,3.134,7,7C19,12.71,16.418,17.444,12.852,18.112z M12.571,29.743c-0.048,0.081-0.063,0.169-0.063,0.257h1.062c1.581-2.749,1.121-3.841,0.153-5.257C13.149,23.905,12.5,22.955,12.5,21c0-0.276-0.224-0.5-0.5-0.5s-0.5,0.224-0.5,0.5c0,2.264,0.774,3.397,1.397,4.308C13.672,26.442,14.141,27.127,12.571,29.743z",
							s: "none",
							t: "t0,0",
							fl: "#333"
						}
			...
			bank: {
				...
				sh: [{
					...
					i: {
						a: {
							p: "M4,26v-1c0-0.553,0.448-1,1-1h22c0.553,0,1,0.447,1,1v1H4z",
							s: "none",
							t: "t0,0",
							o: 1,
							fl: "#333"
					...
					i: {
						a: {
							p: "M30,9v2h-2c0,0.552-0.447,1-1,1H5c-0.552,0-1-0.448-1-1H2V9l13.094-5.825c0.5-0.233,1.312-0.233,1.813,0L30,9z",
							s: "none",
							t: "t0,0",
							o: 1,
							fl: "#333"
			...
			bomb: {
				...
				sh: [{
					...
					f: {
						...
						40: {
							p: "M22.046,12.075l-0.707-0.708l0,0l-0.707-0.707l0,0c0,0-0.316-0.316-0.707-0.707s-0.994-0.42-1.348-0.066l-0.641,0.641c-4.04-2.451-9.371-1.943-12.861,1.547c-4.101,4.101-4.101,10.75,0,14.85s10.749,4.1,14.85,0c3.489-3.49,3.997-8.82,1.547-12.861c0,0,0.287-0.287,0.641-0.641S22.437,12.465,22.046,12.075z M9.997,14.356c-1.173,0.291-2.496,1.585-2.788,2.845c-0.1,0.549-0.577,0.964-1.149,0.964c-0.642,0-1.184-0.526-1.184-1.167c0-0.928,0.659-2.346,1.593-3.291c0.956-0.962,2.484-1.668,3.324-1.667c0.641-0.001,1.166,0.524,1.166,1.167C10.958,13.777,10.545,14.256,9.997,14.356z"
						},
						41: {
							o: 0
						},
					...
					i: {
						a: {
							p: "M16,18.185l-3.09,2.57l1.49-3.733L11,14.877l4.012,0.264L16,11.245l0.989,3.896L21,14.877l-3.399,2.145l1.49,3.733L16,18.185z",
							s: "none",
							t: "s1,1",
							o: 1,
							fl: "#333"
			...
			"ice-cream": {
				...
				sh: [{
					i: {
						a: {
							p: "M19,2h-2.437h-1.688H13c-0.719,0-1.395,0.19-1.978,0.522c-0.586,0.334-1.08,0.812-1.432,1.386C9.216,4.517,9,5.233,9,6v1.25V9v1.9V19c0,2.209,1.791,4,4,4h1.422C14.335,25.571,14,28.4,14,28.4c0,0.883,0.716,1.6,1.6,1.6h0.8c0.883,0,1.6-0.717,1.6-1.6c0,0-0.335-2.829-0.422-5.4H19c2.209,0,4-1.791,4-4v-6.418V10.75V8.9V7.188V6c0-0.711-0.186-1.379-0.511-1.958c-0.209-0.371-0.475-0.706-0.786-0.991C20.991,2.398,20.042,2,19,2z",
							s: "none",
							t: "t0,0",
							o: 1,
							fl: "#333"
					...
					f: {
						...
						10: {
							o: .9,
							p: "M16.563,2H13c0,0-0.799,0.039-1.274,0.208s-0.917,0.36-1.359,0.783s-1.044,1.21-1.205,1.886C9.059,5.308,9,6,9,6v0.999v1.353v1.196V10.9V19c0,2.209,1.791,4,4,4h1.422C14.335,25.571,14,28.4,14,28.4c0,0.883,0.716,1.6,1.6,1.6h0.8c0.883,0,1.6-0.717,1.6-1.6c0,0-0.335-2.829-0.422-5.4H19c2.209,0,4-1.791,4-4v-6.418V8.899l-1.745-0.705l-1.128-1.015L19.202,5.6L19,3.48L19.417,2H16.563z"
						},
						19: {},
						20: {
							o: .8,
							p: "M16.563,2H13l0.969,0.916l0.767,1.421L15,6.299l-0.422,1.827L13.721,9.39l-1.354,1.038l-1.646,0.542L9,10.9V19c0,2.209,1.791,4,4,4h1.422C14.335,25.571,14,28.4,14,28.4c0,0.883,0.716,1.6,1.6,1.6h0.8c0.883,0,1.6-0.717,1.6-1.6c0,0-0.335-2.829-0.422-5.4H19c2.209,0,4-1.791,4-4v-6.418V8.899l-1.745-0.705l-1.128-1.015L19.202,5.6L19,3.48L19.417,2H16.563z"
						},
						29: {},
						30: {
							o: .7,
			...
			medkit: {
				...
				sh: [{
					i: {
						a: {
							p: "M5,28H4c0,0-2,0.031-2-2V10c0,0-0.029-2,2-2l1,0.002V28z M29.997,26V10C29.997,7.907,28,8,28,8h-1v20h0.997C30.153,28,29.997,26,29.997,26z M26,8.001V28H6V8l4,0V6c0,0,0-2,2-2h8.031c0,0,2.002,0.031,1.969,2v2L26,8.001z M12,8h8V7c0,0,0.063-1-1-1h-6c0,0-1-0.1-1,1V8z M23,16h-5v-5h-4v5H9v4h5v5h4v-5h5V16z",
							s: "none",
							t: "t0,0",
							o: 1,
							fl: "#333"
			...
			wine: {
				...
				sh: [{
					i: {
						a: {
							p: "M15.998,19.491c-2.62,0-5.536-1.079-6.276-3.482l1.251-8C14,8,18,8,21.027,8.009l1.251,8C21.538,18.412,18.62,19.491,15.998,19.491z",
							s: "none",
							t: "t0,0",
							o: 1,
							fl: "#333"
					...
					f: {
						0: {
							p: "M15.998,19.491c-2.04,0-2.165-0.283-3.34-0.616l-0.999-0.499c3.299,0.207,5.216,0.791,8.743-0.041l-0.523,0.299C19.375,18.625,18.208,19.491,15.998,19.491z",
							o: 0
						},
						39: {},
						40: {
						...
						50: {
							p: "M15.998,19.491c-2.62,0-5.536-1.079-6.276-3.482l0.062-0.396c4.966-0.613,8.258,3.878,12.225-1.329l0.27,1.725C21.538,18.412,18.62,19.491,15.998,19.491z"
						},
						60: {
							p: "M15.998,19.491c-2.62,0-5.536-1.079-6.276-3.482l0.781-4.993c7.331,3.401,7.373-0.714,10.991-0.027l0.785,5.021C21.538,18.412,18.62,19.491,15.998,19.491z"
						},
						70: {
							p: "M15.998,19.491c-2.62,0-5.536-1.079-6.276-3.482l1.251-8C15,6,17,9,21.027,8.009l1.251,8C21.538,18.412,18.62,19.491,15.998,19.491z"
						},
						80: {
							p: "M15.998,19.491c-2.62,0-5.536-1.079-6.276-3.482l1.251-8C14,8,18,8,21.027,8.009l1.251,8C21.538,18.412,18.62,19.491,15.998,19.491z"
						},
					...
					i: {
						a: {
							p: "M24.419,15.382L22.1,2.592C22.045,2.265,21.731,2,21.4,2H10.6C10.269,2,9.955,2.265,9.9,2.592l-2.319,12.79c0,5.79,7.419,6.25,7.419,6.25v6.263C15,28.946,13.892,29,13.892,29h-3.162c-1.055,0-1.055,1-1.055,1h12.65c0,0,0-1-1.055-1h-3.162c0,0-1.108-0.054-1.108-1.105v-6.263C17,21.632,24.419,21.172,24.419,15.382z M8.7,16.068L10.9,3H21.1l2.2,13.068C21.804,21.963,10.198,21.969,8.7,16.068z",
							s: "none",
							t: "t0,0",
							fl: "#333"
						}
		...
		})).replace(/\"d\":/g, '"duration":').replace(/\"i\":/g, '"init":').replace(/\"f\":/g, '"frames":').replace(/\"fIE\":/g, '"framesIE":').replace(/\"o\":/g, '"opacity":').replace(/\"t\":/g, '"transform":').replace(/\"it\":/g, '"iteration":').replace(/\"sh\":/g, '"shapes":').replace(/\"a\":/g, '"attr":').replace(/\"p\":/g, '"path":').replace(/\"fl\":/g, '"fill":').replace(/\"e\":/g, '"easing":').replace(/\"s\":/g, '"stroke-width":0,"stroke":'),
		z = JSON.parse(C),
		M = Raphael.svg,
		t = Raphael.vml;
	Raphael.fn.createLivicon = function(c, C, z, h, L, s, v, o, V, n, e, H, f) {
			var i = [],
				p = (z = l(e)).shapes.length;
			o = o || z.iteration;
			var a = [],
				r = [],
				d = [],
				S = "s" + H + "," + H + ",0,0";
			if (e = H = !1, C.match(/spinner/)) {
				H = !0;
				var u = jQuery("#" + c),
					m = function() {
						if (u.is(":visible")) {
							if (!y) {
								for (var c = 0; c < p; c++) i[c].animate(a[c].repeat(1 / 0));
								y = !0
							}
						} else if (y) {
							for (c = 0; c < p; c++) i[c].stop();
							y = !1
						}
					}
			}
			for (C.match(/morph/) && (e = !0), C = 0; C < p; C++) {
				var g, b = z.shapes[C].init;
				for (g in b) b[g].transform = S + b[g].transform
			}
			if (M)
				for (C = 0; C < p; C++)
					for (g in b = z.shapes[C].frames) "transform" in b[g] && (b[g].transform = S + b[g].transform);
			else
				for (C = 0; C < p; C++)
					for (g in b = z.shapes[C].framesIE ? z.shapes[C].framesIE : z.shapes[C].frames) "transform" in b[g] && (b[g].transform = S + b[g].transform);
			for (C = 0; C < p; C++) g = z.shapes[C].init.attr, "original" != h && (g.fill = h), d.push(g.fill), i[C] = this.path(g.path).attr(g);
			if (M ? jQuery("#" + c + " > svg").attr("id", "canvas-for-" + c) : jQuery("#" + c).children(":first-child").attr("id", "canvas-for-" + c), c = jQuery("#" + c), f = f || c, 1 == s) {
				if (e) {
					for (C = 0; C < p; C++) a.push(Raphael.animation(z.shapes[C].frames, 200)), r.push(z.shapes[C].init.attr);
					if (L) {
						var k = l(r);
						for (C = 0; C < p; C++) k[C].fill = L
					}
				} else if (s = V || z.duration, !M && t)
					for (C = 0; C < p; C++) z.shapes[C].framesIE ? a.push(Raphael.animation(z.shapes[C].framesIE, s)) : a.push(Raphael.animation(z.shapes[C].frames, s)), r.push(z.shapes[C].init.attr);
				else
					for (C = 0; C < p; C++) a.push(Raphael.animation(z.shapes[C].frames, s)), r.push(z.shapes[C].init.attr);
				if ("click" == n)
					if (v && !e)
						if (H) {
							for (C = 0; C < p; C++) i[C].stop().animate(a[C].repeat(1 / 0));
							var y = !0;
							setInterval(m, 500)
						} else if (L) {
					f.hover(function() {
						for (var c = 0; c < p; c++) i[c].animate({
							fill: L
						}, 200)
					}, function() {
						for (var c = 0; c < p; c++) i[c].animate({
					...
					var E = !0;
					f.click(function() {
						for (var c = 0; c < p; c++) i[c].stop().animate(E ? a[c].repeat(v) : r[c], 0);
						E = !E
					})
				} else E = !0, f.click(function() {
					for (var c = 0; c < p; c++) i[c].stop().animate(E ? a[c].repeat(v) : r[c], 0);
					E = !E
				});
				else e ? L ? (f.hover(function() {
					for (var c = 0; c < p; c++) i[c].animate({
						fill: L
					}, 200)
				}, function() {
				...
				}), E = !0, f.click(function() {
					for (var c = 0; c < p; c++) i[c].stop().animate(E ? a[c] : k[c], 200), E = !E
				})) : (E = !0, f.click(function() {
					for (var c = 0; c < p; c++) i[c].stop().animate(E ? a[c] : r[c], 200), E = !E
				})) : L ? (f.hover(function() {
					for (var c = 0; c < p; c++) i[c].animate({
						fill: L
					}, 200)
					...
					for (var c = 0; c < p; c++) i[c].stop().animate(a[c].repeat(o))
				})) : f.click(function() {
					for (var c = 0; c < p; c++) i[c].stop().animate(a[c].repeat(o))
				});
				else if (v && !e)
					if (H) {
						for (n = 0; n < p; n++) i[n].stop().animate(a[n].repeat(1 / 0));
						y = !0, setInterval(m, 500)
					} else L ? f.hover(function() {
						for (var c = 0; c < p; c++) i[c].stop().animate({
							fill: L
						}, 200).animate(a[c].repeat(v))
					}, function() {
						for (var c = 0; c < p; c++) i[c].stop().animate(r[c], 0)
					}) : f.hover(function() {
						for (var c = 0; c < p; c++) i[c].stop().animate(a[c].repeat(v))
					}, function() {
						for (var c = 0; c < p; c++) i[c].stop().animate(r[c], 0)
					});
				else e ? f.hover(function() {
					if (L)
						for (var c = 0; c < p; c++) i[c].stop().animate({
							fill: L
						}, 200).animate(a[c]);
					else
						for (c = 0; c < p; c++) i[c].stop().animate(a[c])
				}, function() {
					for (var c = 0; c < p; c++) i[c].stop().animate(r[c], 200)
				}) : f.hover(function() {
					if (L)
						for (var c = 0; c < p; c++) i[c].stop().animate(r[c], 0).animate({
							fill: L
						}, 200).animate(a[c].repeat(o));
					else
						for (c = 0; c < p; c++) i[c].stop().animate(r[c], 0).animate(a[c].repeat(o))
				}, function() {
					for (var c = 0; c < p; c++) i[c].animate({
						fill: d[c]
					}, 200)
		...
		function(l) {
			...
			C.counter = 1, l.fn.extend({
				addLivicon: function(M) {
					return this.each(function() {
						var t = l(this);
						t.attr("id") || (L = C(), t.attr("id", "livicon-" + L)), (h = t.data()).liviconRendered && t.removeLivicon(), h = c(h), M && (M = c(M));
						var h = l.extend(h, M),
							L = t.attr("id"),
							s = t.parent(),
							v = h.name ? h.name : "livicon",
							o = h.size ? h.size : 32,
							V = h.eventtype ? h.eventtype : "hover",
							n = o / 32;
						t[0].style.height ? t.css("width", o) : t.css({
							width: o,
							height: o
						});
						var e = v in z ? z[v] : z.livicon,
							H = t.hasClass("activeicon") || s.hasClass("active") ? "red" : "original" == h.color ? "original" : h.color ? h.color : "original",
							f = 0 != h.animate || h.animate,
							i = 1 == h.loop && 1 / 0,
							p = !!h.iteration && 0 < Math.round(h.iteration) && Math.round(h.iteration),
							a = !!h.duration && 0 < Math.round(h.duration) && Math.round(h.duration),
							r = "#000";
						return !1 === h.hovercolor || 0 === h.hovercolor ? r = !1 : !0 === h.hovercolor || 1 === h.hovercolor ? r = "#000" : h.hovercolor && (r = h.hovercolor), h = 1 == h.onparent && s, Raphael(L, o, o).createLivicon(L, v, o, H, r, f, i, p, a, V, e, n, h), t.data("liviconRendered", !0), this
					})
				},
				removeLivicon: function(c) {
					return this.each(function() {
						var C = l(this);
						if (C.data("liviconRendered", !1), "total" !== c) {
							var z = C.attr("id");
							return l("#canvas-for-" + z).remove(), C
						}
						C.remove()
					})
				},
				updateLivicon: function(c) {
					return this.each(function() {
						var C = l(this);
						return C.removeLivicon().addLivicon(c), C
					})
				},
				dataofLivicon: function(c) {
					var l = (l = this.data("n") || this.data("name")) in z ? z[l] : z.livicon;
					return "duration" === c || "d" === c ? l.duration : "iteration" === c || "i" === c ? l.iteration : this
				}
			}), l(".livicon").addLivicon()
		}(jQuery), jQuery(".live-code").addLivicon({
			name: "code",
			size: 28,
			color: "#fff",
			hovercolor: "#fff",
			...
			animate: "true",
			onparent: !0
		}), jQuery(".menu-contact").addLivicon({
			name: "cellphone",
			size: 28,
			color: "#fff",
			hovercolor: "#fff",
			animate: "true",
			onparent: !0
		}), jQuery(".menu-notebook").addLivicon({
			name: "notebook",
			size: 28,
			color: "#fff",
			hovercolor: "#fff",
			animate: "true",
			onparent: !0
		}), jQuery(".header-rocket").addLivicon({
			name: "rocket",
			size: 16,
			color: "#fff",
			hovercolor: "#fff",
			animate: "true",
			onparent: !0
		}), jQuery(".header-phone").addLivicon({
			name: "phone",
			size: 20,
			color: "#fff",
			hovercolor: "#fff",
			...
			animate: "true",
			onparent: !0
		}), jQuery(".header-skype").addLivicon({
			name: "skype",
			size: 20,
			color: "#fff",
			hovercolor: "#fff",
			animate: "true",
			onparent: !0
		}), jQuery(".live-dashboard").addLivicon({
			name: "dashboard",
			size: 36,
			color: "#fff",
			hovercolor: "#fff",
			...
			animate: "true",
			onparent: !0
		}), jQuery(".live-responsive").addLivicon({
			name: "responsive",
			size: 48,
			color: "#fff",
			hovercolor: "#fff",
			...
			animate: "true",
			onparent: !0
		}), jQuery(".live-imageh2").addLivicon({
			name: "image",
			size: 32,
			color: "#2b2a29",
			hovercolor: "#2b2a29",
			animate: "true",
			onparent: !0
		}), jQuery(".live-calendar").addLivicon({
			name: "calendar",
			size: 16,
			color: "#2b2a29",
			hovercolor: "#2b2a29",
			...
			animate: "true",
			onparent: !0
		}), jQuery(".footer-clock").addLivicon({
			name: "clock",
			size: 40,
			color: "#fff",
			hovercolor: "#fff",
			animate: "true",
			onparent: !0
		}), jQuery(".footer-phone").addLivicon({
			name: "phone",
			size: 40,
			color: "#fff",
			hovercolor: "#fff",
			...
			animate: "true",
			onparent: !0
		}), jQuery(".footer-skype").addLivicon({
			name: "skype",
			size: 40,
			color: "#fff",
			hovercolor: "#fff",
